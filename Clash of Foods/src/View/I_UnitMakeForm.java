 ...
 * @author 이상명'spc
 */
public class I_UnitMakeForm extends B_UnitMakeForm { //이삭 유닛생산 프레임
    ...
    /**
     * Creates new form I_UnitMakeForm
     */
    public I_UnitMakeForm() {
        initComponents();
    }
    public I_UnitMakeForm(Player p,Unit[] u,B_BasicForm bf, UnitControl um){
        this();
        this.p = p;
        this.units = u;
        this.bf = bf;
